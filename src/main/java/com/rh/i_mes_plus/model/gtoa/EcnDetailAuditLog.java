...
@TableName("ecn_detail_audit_log")
public class EcnDetailAuditLog extends SuperEntity {
    private static final long serialVersionUID=1L;
        ...
        @Excel(name = "截至时间(2099-12-31 23:59:59永久有效)",format="yyyy-MM-dd HH:mm:ss")
        @ApiModelProperty(value = "截至时间(2099-12-31 23:59:59永久有效)")
