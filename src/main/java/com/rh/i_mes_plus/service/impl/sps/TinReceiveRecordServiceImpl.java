...
import com.rh.i_mes_plus.mapper.sps.TinReceiveRecordMapper;
...
@Slf4j
@Service
public class TinReceiveRecordServiceImpl extends ServiceImpl<TinReceiveRecordMapper, TinReceiveRecord> implements ITinReceiveRecordService {
    @Resource
    private TinReceiveRecordMapper tinReceiveRecordMapper;
    /**
     * 列表
     * @param params
     * @return
    ...
    public Page<Map> findList(Map<String, Object> params){
        ...
        return tinReceiveRecordMapper.findList(pages, params);
    }
    ...
    public Result getDocNo(Map<String, Object> map) {
        ...
        TinReceiveRecord one = getOne(new QueryWrapper<TinReceiveRecord>()
